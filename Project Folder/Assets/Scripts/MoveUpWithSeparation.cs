...
public class MoveUpWithSeparation : MonoBehaviour
{
    public float moveDistance = 0.02f; // Distance de déplacement vers le haut
    public float separationDistance = 0.1f; // Distance de séparation
    public float maxMoveDistance = 0.5f; // Limite maximale de déplacement
    public float duration = 1.0f; // Durée du déplacement
    public float moveDistanceLeft = 0.03f; // Distance de déplacement vers la gauche
    public float moveDistanceRight = 0.1f; // Distance de déplacement vers la droite
    public bool moveLeft = true; // Indicateur de déplacement vers la gauche
